...
import {Groth16Verifier} from "../src/Roundabout.sol";

contract Solve is Script {
    Groth16Verifier public roundabout;
    uint256 deployerPrivkey;

    function setUp() public {
        deployerPrivkey = vm.envUint("SOLVER_PRIVATE_KEY");
        roundabout = Groth16Verifier(vm.envAddress("ROUNDABOUT_ADDR"));
    }
    ...
    function run() public {
        ...
        bool ok = roundabout.verifyProof(pA, pB, pC, pubSignals);
        require(ok, "flag is not true.");
